...
namespace VisionCraft
{
    ...
    public:
         ...
         */
        ImVec2 GetCanvasPosition() const { return currentCanvasPos; }

        /**
         * @brief Gets the current canvas size.
         * @return Canvas size
         */
        ImVec2 GetCanvasSize() const { return currentCanvasSize; }
         ...
         */
        ImVec2 GetPanOffset() const { return ImVec2(panX, panY); }
